...
const Accessibility = () => {
  ...
  return (
    <>
      {/* Sidebar Content */}
<div id="sidebar" className="sidebar  text-white sidebar-menu_filter-box">
        <h3 className="filter-menu-header-text-box">

            <div className="jsx-4107003866 d-flex align-items-center offcanvas-title">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        fill="#1D0A69" className="jsx-4107003866"></path>
                    <path
                ...
                <h3 id="accessibility_panel" className="jsx-4107003866">Accessibility Controls</h3>
            </div>

        </h3>
        <button className="close-btn btn btn-danger1" onClick={() => window.closeSidebar && window.closeSidebar()}><i className="fa fa-times"
                ...
                <div className="jsx-4107003866 row g-3 mb-16">
                    <div className="jsx-4107003866 col-lg-6 col-md-12 padd-r-0">
                        <div role="button" tabIndex="0" aria-label="Dark Contrast"
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Dark Contrast
                            </p>
                        </div>
                    </div>
                        ...
                        <div role="button" tabIndex="0" aria-label="Invert"
                            ...
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    ...
                                    <g id="contrast">
                                        <mask id="mask0_69_158538" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Invert</p>
                        </div>
                    </div>
                    <div className="jsx-4107003866 col-lg-6 col-md-12 padd-r-0">
                        <div role="button" tabIndex="0" aria-label="Saturation"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="invert_colors">
                                        <mask id="mask0_69_158549" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="40" height="40">
                                            <rect id="Bounding box" width="40" height="40" fill="#D9D9D9"></rect>
                                        </mask>
                                        <g mask="url(#mask0_69_158549)">
                                            <path id="invert_colors_2"
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Saturation</p>
                        </div>
                    </div>
                    <div className="jsx-4107003866 col-lg-6 col-md-12">
                        <div role="button" tabIndex="0" aria-label="Text Size Increase"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="text_increase">
                                        <mask id="mask0_69_158560" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="40" height="40">
                                            <rect id="Bounding box" width="40" height="40" fill="#D9D9D9"></rect>
                                        </mask>
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Text Size
                                Increase</p>
                        </div>
                    </div>
                    <div className="jsx-4107003866 col-lg-6 col-md-12 padd-r-0">
                        <div role="button" tabIndex="0" aria-label="Text Size Decrease"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="text_decrease">
                                        <mask id="mask0_69_157790" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="40" height="40">
                                            <rect id="Bounding box" width="40" height="40" fill="#D9D9D9"></rect>
                                        </mask>
                                        <g mask="url(#mask0_69_157790)">
                                            <path id="text_decrease_2"
                    ...
                    <div className="jsx-4107003866 col-lg-6 col-md-12">
                        <div role="button" tabIndex="0" aria-label="Highlight Links"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="link">
                                        <mask id="mask0_69_158582" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Highlight Links
                            </p>
                        </div>
                    </div>
                    <div className="jsx-4107003866 col-lg-6 col-md-12 padd-r-0">
                        <div role="button" tabIndex="0" aria-label="Hide Images"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="hide_image">
                                        <mask id="mask0_69_158626" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="48" height="48">
                                            <rect id="Bounding box" width="48" height="48" fill="#D9D9D9"></rect>
                                        </mask>
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Hide Images</p>
                        </div>
                    </div>
                    <div className="jsx-4107003866 col-lg-6 col-md-12">
                        <div role="button" tabIndex="0" aria-label="Default Cursor"
                            className="jsx-4107003866 false d-flex align-items-center flex-column pointer option-card">
                            <div className="jsx-4107003866 accessibility-icon">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="web_traffic">
                                        <mask id="mask0_69_158637" style={{}} /* Original: style="mask-type:alpha" */ maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="48" height="48">
                                            <rect id="Bounding box" width="48" height="48" fill="#D9D9D9"></rect>
                                        </mask>
                                        <g mask="url(#mask0_69_158637)">
                                            <path id="web_traffic_2"
                            ...
                            <p aria-hidden="true" className="jsx-4107003866 text-uppercase text-center mb-0">Default Cursor
                            </p>
                        </div>
                    </div>
                </div>
