                                ...
                                <div className="camp-outer-box12 sub-campis-box">
                                    ...
                                    <div className="camp-text-outer-box12 news-title-text">
                                        ...
                                        <h3 className="sub-camp-title-box">
                                            <a href="#">Call for proposals for short-term fellowship (1-3 months) under Synergy-2024 Programme</a>
                                        </h3>
                                        <p>The fellowship amount will be up to Rs 65,000/- for PhD students and up to Rs 1,00,000/- for post-doctoral fellows.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="research-highlights-card-item hover-effect">
                                                ...
                                                <div className="card-content">
                                                    ...
                                                    <h5 style={{ fontSize: '1.1rem', marginBottom: '8px' }}>
                                                        <a href="#" className="text-secondary">Dr. Amit Awasthi's breakthrough study on inflammatory bowel disease published in mucosal immunology</a>
                                                    </h5>
                                                    <p className="text-muted" style={{ fontSize: '0.9rem', lineHeight: '1.4' }}>Breakdown of gastrointestinal (GI) tract's functions...</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="research-highlights-card">
                                            <div className="research-highlights-card-item hover-effect">
                                                ...
                                                <div className="card-content">
                                                    ...
                                                    <h5 style={{ fontSize: '1.1rem', marginBottom: '8px' }}>
                                                        <a href="#" className="text-secondary">Shri L.S. Changsan, Joint Secretary (DoHFW, MoHFW, Govt. of India)</a>
                                                    </h5>
                                                    <p className="text-muted" style={{ fontSize: '0.9rem', lineHeight: '1.4' }}>Visited Translational Health Science and Technology...</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="research-highlights-card">
                                            <div className="research-highlights-card-item hover-effect">
                                                ...
                                                <div className="card-content">
                                                    ...
                                                    <h5 style={{ fontSize: '1.1rem', marginBottom: '8px' }}>
                                                        <a href="#" className="text-secondary">The results of PhD program 2023-24 (winter session) have been announced.</a>
                                                    </h5>
                                                    <p className="text-muted" style={{ fontSize: '0.9rem', lineHeight: '1.4' }}>Breakdown of gastrointestinal (GI) tract's functions...</p>
                                                </div>
                                            </div>
