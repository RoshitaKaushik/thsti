...
namespace ThstiServer.Controllers
{
    ...
    public class FooterLinksController : ControllerBase
    {
        ...
        {
            var items = await _context.FooterLinks
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] FooterLink item)
        {
            item.CreatedAt = DateTime.UtcNow;
            item.UpdatedAt = DateTime.UtcNow;
            _context.FooterLinks.Add(item);
        ...
        public async Task<IActionResult> Reorder([FromBody] ThstiServer.DTOs.GenericReorderRequest req)
        {
            ...
            try
            {
                ...
                {
                    var item = await _context.FooterLinks.FindAsync(order.Id);
