                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-12" >
                                        <div class="col-md-5">
											...
											echo form_open("admin/Reports/indivisualReport", $attr); 
											?>
                      ...
                      $param['cary_hours_to_work'] = hourMinuteFormating($cary_Sum_hour_contract,$cary_Sum_mins_contract);*/
                        ...
                        //$total_worked =(float)$total_worked;
                                ...
                                <div class="col-md-12" > 
                                    ...
                                    <div class="col-md-2"> 
                                        <?php $grandsumhr=hourdecFormating($main_sum_hr['t_hours'],$main_sum_hr['t_minutes']) ; ?>
                                        <?=@calc_hrtodays($grandsumhr)?>
                                    ...
                                    <div class="col-md-2">  
                                        <?php  echo    $grandsumhr=hourdecFormating($main_sum_hr['t_hours'],$main_sum_hr['t_minutes']) ; ?>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-4" style="font-weight: bold;">
