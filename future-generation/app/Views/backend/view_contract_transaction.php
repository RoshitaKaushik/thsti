<?php //echo "<pre>";print_r($contractor_details);
...
//echo "<pre>";print_r($group_by_contract);die; 
			...
			<div class="col-md-12">
				<div class="panel panel-info panel-color">
					<div class="panel-heading">
						<h3 class="panel-title">Attendance List <?php if(isset($empdetails)){
					...
					<div class="panel-body">
						<div class="row">
							...
							<div id = 'newHideOrphan' class="col-md-12 col-sm-12 col-xs-12 <?=$show_class?> <?=$count != 1 ?'contract_details' : ''?>">
								<div class="col-sm-12 " >
							...
							<div class="clearfix"></div>
								<div class="<?php if($curdate!='0'){ echo "curr_div"; } ?> col-md-12 col-sm-12 col-xs-12 <?php if($curdate=='0'){ echo "show"; } else { echo "hide"; } ?>  <?=$count != 1 ?'contract_details' : ''?>">
						...
						<!-- start orphan table -->
						<div id="orphanSpan" class="col-md-12 col-sm-12 col-xs-12 <?=$show_class??''?> <?=$count??0 != 1 ?'contract_details' : ''?>">
							<div class="col-sm-12">
						...
						<div id="OrphanSection" class="col-md-12 col-sm-12 col-xs-12 <?=$show_class??''?> <?=$count??0 != 1 ?'contract_details' : ''?>">
								<table id="" class="table table-striped table-bordered">
									<thead>
										<tr>
											<th>S.No.</th>
