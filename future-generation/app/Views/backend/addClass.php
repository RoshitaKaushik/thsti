	...
	<div class="content">
		<div class="container">
			...
			<div class="alert alert-success">
				...
				<?php } ?>
				<!-- Page-Title -->
				<?php echo form_open_multipart("admin/Master/submitaddClass"); ?>
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-color panel-info">
						<div class="panel-heading">
							<h3 class="panel-title"> Add Class
							<?php
							if($add_permission)
							{
							    ?>
									...
									<div class="modal-dialog">
										<div class="modal-content p-0 b-0">
											<div class="row">
												...
												<div class="col-md-12">
													<div class="panel panel-color panel-info">
														<div class="panel-heading"><h3 class="panel-title">Add Class  </h3>
														</div>
														<div class="panel-body">
															<div class="col-md-12">	
																<div class="form-group">
																	<input type="hidden" name="ROWID" value="<?php if(isset($edit_class[0]) ) { echo $edit_class[0]['ROWID']; } ?>" >
																	<label>Class <span class="requires">*</span></label>
																	<input type="text" class="form-control num" id="Class" name="Class" placeholder="Enter Class  " value ="<?php if(isset($edit_class[0]) ) { echo $edit_class[0]['Class']; } ?>" maxlength="4"  required>
																</div>
															</div>
															<div class="col-md-12">	
																<div class="form-group">
																	<label for="Active">Class Status <span class="requires">*</span></label>
																	<select class="form-control" name="Active" required>
																		<option value="">Select</option>	
																		<option value="1"  <?php if(isset($edit_class[0])){if(1==$edit_class[0]['Active']){ echo "Selected";}} ?>>Active</option>									
																		<option value="2"  <?php if(isset($edit_class[0])){if(2==$edit_class[0]['Active']){ echo "Selected";}} ?>>Inactive</option>										
																	</select>
																</div>
															</div>
														</div>	<!-- panel-body -->
											...
											<tr>
												...
												<td>
												    <?php
                            							...
                            							{
                            							    ?>
													<a href="<?=base_url('')?>admin/Master/addClass/<?=encryptor('encrypt', $row['ROWID'])?> " 	class="btn btn-info waves-effect waves-light btn-xs m-b-5">
 ...
 <script type="text/javascript"> 
	$(document).on("click", ".rmv", function() { 
		...
		if(confirm('Are you sure, Want to Delet this record?')){ 
			...
			$.ajax({ 
				type: "POST", 
				url: "<?=base_url()?>" + "admin/Master/delClass",  
