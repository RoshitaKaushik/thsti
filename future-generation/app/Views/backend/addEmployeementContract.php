				...
				<div class="col-md-12">
					<div class="panel panel-color panel-info">
						<div class="panel-heading">
							<h3 class="panel-title"> Add Contract
														...
														<div class="panel-body">
															...
															<div class="col-md-6">	
																<div class="form-group">
																	...
																	<input type="text" class="form-control empid validate"
																	id="empid" name="empid" placeholder="Enter ID "
																	value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['empid']; } ?>"   required>
																</div>
															</div>											
															<div class="col-md-6">	
																<div class="form-group">
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control validate" id="FirstName" name="FirstName" placeholder="Employee First Name" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['FirstName']; }?>"   required>
																</div>
															</div>
															<div class="col-md-6">	
																<div class="form-group">																	
																	<label>Employee Last Name <span class="requires">*</span></label>
																	<input type="text" class="form-control validate" id="LastName" name="LastName" placeholder="Employee Last Name " value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['LastName']; } ?>"  required>
																</div>
															</div>
															<div class="col-md-12">	
																<div class="form-group">																	
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control campare_date datepicker validate" id="contract_begin_date" name="contract_begin_date" placeholder="Contract Begin Date" value ="<?php if(isset($edit_contract[0]) ) { echo convertDateString($edit_contract[0]['contract_begin_date']); } ?>"  required>
																</div>
															</div>
															<div class="col-md-6">	
																<div class="form-group">																	
																	<label>Contract End Date <span class="requires">*</span></label>
																	<input type="text" class="form-control campare_date datepicker end_date validate" id="contract_end_date" name="contract_end_date" placeholder="Contract End Date" value ="<?php if(isset($edit_contract[0]) ) { echo convertDateString($edit_contract[0]['contract_end_date']); } ?>"   required>
																</div>
															</div>
															...
															<div class="col-md-6">
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control validate" id="hours_to_work" name="hours_to_work" placeholder="Working Hours" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['hours_to_work']; } ?>"   required>
																</div>
															</div>
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control validate" id="CarriedOverHours" name="CarriedOverHours" placeholder="Carried Over Hours" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['CarriedOverHours']; } ?>"   required>
																</div>
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control validate" id="Education" name="education" placeholder="Education" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['education']; } ?>"   required>
																</div>
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" class="form-control validate" id="daily_rate" name="daily_rate" placeholder="Daily rate" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['daily_rate']; } ?>"   required>
																</div>
															</div>
															...
															<div class="col-md-6">	
																<div class="form-group">																	
																	...
																	<input type="text" maskedFormat="10,2" class="form-control maskedExt validate" id="adjunct_fee" name="adjunct_fee" placeholder="Adjunct Fee" value ="<?php if(isset($edit_contract[0]) ) { echo $edit_contract[0]['adjunct_fee']; } ?>"   required>
																</div>
															</div>
                                                            ...
                                                            <div class="col-md-6">	
                                                                <div class="form-group">  
                                                                    <label >1099</label>
                                                                    <select  class="form-control validate" id="contract_1099" name="contract_1099" required>
                                                                        <option value="" >-Select-</option>
 ...
 <script type="text/javascript"> 
    ...
    function form_submit_data()
    {
        ...
        $.ajax({
            ...
            data: {tab_type:tab_type,submit:'submit','facultyEmployeeID':"<?= isset($facultystaffid)?$facultystaffid:'' ?>"},
...
<div id="panel-edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" 	style="display: none;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content p-0 b-0">
			<div class="row">
					<!-- Basic example -->
				<div class="col-md-12">
					<div class="panel panel-color panel-info">
						...
						<?php
						$attr = array("name" => "edit_contract_data", "id"=>"edit_contract_data");
			            echo form_open_multipart("admin/Reports/submitContract", $attr); 
						?>
						<div class="panel-body">
							<div class="col-md-12">
								<div id="note"></div>
							</div>
							<span id="edit_contract_part"></span>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
								<?php if(isset($edit_contract[0])){ ?>
								  <input type="submit" class="btn btn-success edit_submit_button" name="submit" value="Save"  id="contact_form_btn"  >
								<?php }else{
								    ?>
								    <input type="submit" class="btn btn-success edit_submit_button" name="submit" value="Save"  >
								    <?php
								}?>
