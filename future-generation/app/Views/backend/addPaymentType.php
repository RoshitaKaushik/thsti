	...
	<div class="content">
		<div class="container">
			...
			<div class="alert alert-success">
				...
				<?php } ?>
				<!-- Page-Title -->
				<?php echo form_open_multipart("admin/Master/submitPaymentType"); ?>
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-color panel-info">
						<div class="panel-heading">
							<h3 class="panel-title"> Add Payment Type
									...
									<div class="modal-dialog">
										<div class="modal-content p-0 b-0">
											<div class="row">
												...
												<div class="col-md-12">
													<div class="panel panel-color panel-info">
														<div class="panel-heading"><h3 class="panel-title">Add Payment Type  </h3>
														</div>
														<div class="panel-body">
															<div class="col-md-12">	
																<div class="form-group">
																	<input type="hidden" name="ROWID" value="<?php if(isset($edit_pay[0]) ) { echo $edit_pay[0]['ROWID']; } ?>" >
																	<label>Payment Type  <span class="requires">*</span></label>
																	<input type="text" class="form-control " id="PayType" name="PayType" placeholder="Enter Payment Type   " value ="<?php if(isset($edit_pay[0]) ) { echo $edit_pay[0]['PayType']; } ?>"   required>
																</div>
															</div>
									...
									<table id="alldataTable" class="table table-striped table-bordered alldataTable">
										...
										<tbody> 
											...
											<tr>
												...
												<td>
													<a href="<?=base_url('')?>admin/Master/addPaymentType/<?=encryptor('encrypt', $row['ROWID'])?> " 	class="btn btn-info waves-effect waves-light btn-xs m-b-5">
 ...
 <script type="text/javascript"> 
	$(document).on("click", ".rmv", function() { 
		...
		if(confirm('Are you sure, Want to Delete this record?')){ 
			...
			$.ajax({ 
				type: "POST", 
				url: "<?=base_url()?>" + "admin/Master/delPaymentType",  
