...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
    		...
    		<!--div class="row">
    			<div class="col-sm-12">
    				<h4 class="pull-left page-title">Email Templete</h4>
    			</div>
    		</div-->
    			...
    			<div class="col-md-12">
    				<div class="panel panel-info panel-color">
    					<div class="panel-heading">
    						<h3 class="panel-title">Email Templete
        					            ...
        					            <div class="col-md-2 text_design">
        					             ...
        					             <div class="col-md-7">
        					                 <select class="form-control" name="type" id="type">
        					                     <option value="">Please Select Templete</option>
        					                     <?php
        					            ...
        					            <div class="col-md-2 text_design">
        					             ...
        					             <div class="col-md-7">
        					                <select class="form-control"  id="name_type">
        					                    ...
        					                    <option value="#ReferenceName">#ReferenceName</option>
        					                    <option value="#Addresee">#Addresee</option> 
...
$(document).on('change','#name_type',function(){
    var data = $(this).val();
...
$(document).on('change','#type',function(){
    ...
    $.ajax({
         url:'<?= base_url('admin/Registration/get_templete_detail') ?>',
         method: 'post',
         ...
         success: function(response){
           ...
           CKEDITOR.instances['description'].setData(response[0]['body']);
         }
       });
...
$(document).on('click','.save_data',function(){
     ...
     var submit = "submit";
    $.ajax({
         url:'<?= base_url('admin/Registration/update_templete_detail') ?>',
         method: 'post',
         data: {description,type,from,subject,submit},
         dataType: 'html',
         success: function(response){
            if(response)
            {
