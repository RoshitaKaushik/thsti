...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
    		...
    		<div class="row">
    			<div class="col-sm-12">
    				<h4 class="pull-left page-title">Add Degree</h4>
    			</div>
    		</div>
    			...
    			<div class="col-md-12">
    				<div class="panel panel-info panel-color">
    					<div class="panel-heading">
    						<h3 class="panel-title">Add Degree
    					...
    					<div class="panel-body">
    					    ...
    					    <div class="col-md-12" style="text-align:right;">
    					        <button class="btn btn-primary" data-toggle="modal" data-target="#addcity">Add Degree</button>
    					    </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form method="post" action="<?= base_url('admin/Registration/store_degree') ?>">
              <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
            <div class="modal-body">
            
          <div class="form-group">
              <label>Degree ID :</label>
              <input type="text" class="form-control" name="degree_id" required placeholder="Enter Degree Id">
          </div>
          <div class="form-group">
              <label>Degree Name :</label>
              <input type="text" class="form-control" name="degree_name" required placeholder="Enter degree Name">
          </div>
