...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
    		...
    		<div class="row">
    			<div class="col-sm-12">
    				<h4 class="pull-left page-title">Add Ethnicity</h4>
    			</div>
    		</div>
    			...
    			<div class="col-md-12">
    				<div class="panel panel-info panel-color">
    					<div class="panel-heading">
    						<h3 class="panel-title">Add Ethnicity
    					...
    					<div class="panel-body">
    					    ...
    					    <div class="col-md-12" style="text-align:right;">
    					        <button class="btn btn-primary" data-toggle="modal" data-target="#addcity">Add Ethnicity</button>
    					    </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Ethnicity</h4>
        </div>
          <form method="post" action="<?= base_url('admin/Registration/store_ethnicity') ?>">
              <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
            <div class="modal-body">
            
          <div class="form-group">
              <label>Ethnicity ID :</label>
              <input type="text" class="form-control" name="ethnicity_id" required placeholder="Enter Ethnicity Id">
          </div>
          <div class="form-group">
              <label>Ethnicity Name :</label>
              <input type="text" class="form-control" name="ethnicity_name" required placeholder="Enter Ethnicity Name">
          </div>
...
<script>
    $(document).on('click','.edit_city',function(){
        ...
        var url = "<?= base_url() ?>/admin/Registration/get_detail_of_ethnicity";
        $.ajax({
                method: 'post',
                url: url,
                data: {"rel_id":rel_id},
  ...
  <div class="modal fade" id="edit_city" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Update Ethnicity</h4>
        </div>
          <form method="post" action="<?= base_url('admin/Registration/update_ethnicity') ?>">
              <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>">
            <div class="modal-body">
